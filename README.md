...
**Tuco** version **0.3.0-M2** is available for cats 1.0.0-MF, cats-effect 0.4, decline 0.4.0-M1, and monocle 1.5.0-cats-M1. This version will track cats milestones until 1.0 becomes final.
